  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 4-pillar grid: 4 cols on desktop, 2 on tablet, 1 on mobile */}
          ...
          {AI_PILLARS.map((pillar) => {
            ...
            return (
              <Link
                key={pillar.id}
                href={pillar.href}
                className="group rounded-2xl p-6 flex flex-col justify-between border transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
                style={{
