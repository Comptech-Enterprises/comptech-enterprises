...
export const INDUSTRIES = [
  { icon: "heart-pulse", title: "Healthcare",     desc: "Hospital networks, PACS systems, and medical IT infrastructure." },
  { icon: "graduation",  title: "Education",      desc: "Campuswide Wi-Fi, smart classrooms, and student device programs." },
  { icon: "landmark",    title: "Government",     desc: "Secure infrastructure for government offices and municipalities." },
  { icon: "factory",     title: "Manufacturing",  desc: "OT/IT convergence, ERP servers, and plant-floor computing." },
  { icon: "shopping-bag",title: "Retail",         desc: "POS systems, inventory servers, and CCTV for retail chains." },
  { icon: "banknote",    title: "Finance",         desc: "High-availability trading and banking IT infrastructure." },
  { icon: "code-2",      title: "IT Services",    desc: "Dev workstations, collaboration tools, and cloud infrastructure." },
];
...
export const CASE_STUDIES = [
  ...
  },
  {
    ...
    excerpt: "Designed and deployed a campus-wide Wi-Fi 6E network across 8 buildings supporting 5,000+ concurrent users with centralized management.",
  ...
  },
  {
    ...
    excerpt: "Deployed 500+ IP cameras with AI-powered video analytics and a central command center for 24/7 surveillance operations.",
...
export const TESTIMONIALS = [
  {
    quote: "Comptech transformed our IT infrastructure. Their team deployed our entire server environment in under 3 weeks with zero downtime — exceptional execution.",
    name: "Rajesh Mehta",
    title: "CTO, Apollo Hospitals Group",
    initials: "RM",
  },
  {
    quote: "The Wi-Fi rollout across our 8 campuses was seamless. Comptech's engineers were certified, responsive, and delivered ahead of schedule.",
    name: "Dr. Priya Nair",
    title: "IT Director, Mumbai University",
    initials: "PN",
  },
  {
    quote: "Best enterprise IT partner we've worked with in 15 years. Their AMC team resolves issues before we even notice them — truly proactive support.",
    name: "Arun Sharma",
    title: "CIO, HDFC Asset Management",
    initials: "AS",
  },
  {
    quote: "From procurement to deployment to maintenance — Comptech delivers end-to-end with unmatched expertise. Our go-to partner for all IT needs.",
    name: "Vikram Singh",
    title: "VP Technology, Reliance Retail",
    initials: "VS",
  },
  {
    quote: "Their AI workshop transformed how our team thinks about automation. The no-code platform they deployed has saved us 400+ man-hours per month.",
    name: "Meera Krishnan",
    title: "Head of Innovation, Tata Motors",
    initials: "MK",
  },
  {
    quote: "Government-grade security deployed on time and on budget. Comptech understands the unique requirements of public sector IT procurement.",
    name: "Suresh Yadav",
...
export const BLOG_POSTS = [
  {
    ...
    excerpt: "Cost, compliance, latency, and support — the factors that actually matter when choosing a cloud platform for Indian enterprise workloads.",
    readTime: "7 min",
    date: "Dec 15, 2024",
    featured: true,
  },
