                  ...
                  {demoSubmitted ? (
                    ...
                    >
                      {[
                        ...
                        <div key={key}>
                          ...
                          <input
                            type={type}
                            required
                            className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-white/50 focus:ring-2 focus:ring-white/10 outline-none transition-all"
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-sm text-white focus:border-white/50 outline-none transition-all"
                          value={demoForm.date}
                      ...
                      <div>
                        ...
                        >
                          ...
                          {["Infrastructure", "AI", "Cloud", "CCTV", "Networking"].map((s) => (
                            <option key={s} className="text-gray-900">
                              {s}
                            </option>
                          ))}
                        </select>
                      ...
                      <button
                        type="submit"
                        className="btn btn-lg w-full bg-white text-blue-700 font-semibold rounded-2xl hover:bg-blue-50 transition-colors mt-2"
                      >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              <RevealWrapper className="lg:col-span-2">
                <div
                  className="rounded-3xl h-72 flex flex-col items-center justify-center text-white"
                  style={{ background: "linear-gradient(135deg, #001A57 0%, #003DA5 100%)" }}
                >
                  <MapPin size={40} className="mb-3 opacity-80" />
                  <p className="font-semibold text-lg">Comptech Enterprises</p>
                  <p className="text-white/70 text-sm mt-1">Janakpuri, Delhi, India</p>
                  <a
